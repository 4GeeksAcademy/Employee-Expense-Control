...
Revision ID: 57f343ac69bd
Revises: 
<<<<<<<< HEAD:migrations/versions/2dcdfa26b67d_.py
...
========
Create Date: 2025-05-21 18:03:49.067992
>>>>>>>> 1eb7a7811e02e6cbeb499b0ff228c0e339964c08:migrations/versions/57f343ac69bd_.py
...
def upgrade():
    ...
    op.create_table('bills',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('trip_description', sa.String(
                        length=250), nullable=False),
                    sa.Column('trip_address', sa.String(
                        length=250), nullable=False),
                    sa.Column('state', sa.Enum('APPROVED', 'DENEGATED',
                                               'PENDING', name='state_type'), nullable=False),
                    sa.Column('amount', sa.Numeric(
                        precision=10, scale=2), nullable=False),
