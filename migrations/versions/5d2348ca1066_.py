...
Revision ID: 5d2348ca1066
Revises: 
Create Date: 2025-05-20 13:26:21.331028
...
def upgrade():
    ...
    sa.Column('state', sa.Enum('ACCEPTED', 'REFUSED', 'PENDING', name='state_budget'), nullable=False),
